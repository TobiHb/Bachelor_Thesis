# 03_BERT_TAPT_Finetuning.ipynb
### Purpose: Fine-tune TAPT model (bert-tapt) and compare performance against baseline BERT
...
## 2. Load TAPT Tokenizer & Model
tapt_model_path = "bert-tapt"  # Change to "bert-tapt" in Notebook 3
tokenizer = BertTokenizerFast.from_pretrained(tapt_model_path)
...
training_args = TrainingArguments(
    ...
    save_total_limit=2,
    report_to="none",
    output_dir="bert-tapt-finetuned",
    seed=42,        
    data_seed=42,
...
## 11. Save Final Model
model.save_pretrained("./bert-tapt-finetuned")
tokenizer.save_pretrained("./bert-tapt-finetuned")
print("Fine-tuned TAPT model saved to: bert-tapt-finetuned")
